...
class TsysSaratogaIntegrationSettings(SwaggerSerializable):
    swagger_types = {
        'use_unique_ref': 'bool',
        ...
        'enable_bank_response_code_xml_response_tag': 'bool',
    ...
    attribute_map = {
        ...
        'enable_bank_response_code_xml_response_tag': 'enableBankResponseCodeXmlResponseTag',
    ...
    def __init__(self, use_unique_ref=True, enable_auto_ready=True, auto_ready_amount_limit=0, hosted_page_version='VERSION_2', enable_background_validation=False, background_validation_url=None, receipt_page_url=None, mpi_receipt_url=None, enable_additional_field_xml_response_tag=True, enable_original_response_xml_response_tag=False, enable_bank_response_code_xml_response_tag=False, enable_masked_card_xml_response_tag=False, enable_supports_apple_pay_xml_response_tag=True, enable_supports_google_pay_xml_response_tag=True, enable_enable3ds_xml_response_tag=True, enable_supported_cards_xml_response_tag=True):  # noqa: E501
        ...
        self._enable_bank_response_code_xml_response_tag = None
        ...
        if enable_bank_response_code_xml_response_tag is not None:
            self.enable_bank_response_code_xml_response_tag = enable_bank_response_code_xml_response_tag
    ...
    @property
    def enable_bank_response_code_xml_response_tag(self):
        return self._enable_bank_response_code_xml_response_tag

    @enable_bank_response_code_xml_response_tag.setter
    def enable_bank_response_code_xml_response_tag(self, enable_bank_response_code_xml_response_tag):
        self._enable_bank_response_code_xml_response_tag = enable_bank_response_code_xml_response_tag
