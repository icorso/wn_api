...
class ElavonTerminal(SwaggerSerializable):
    swagger_types = {
        ...
        'bank_settings': 'ElavonBankSettings',
        'terminal_location': 'TerminalLocationDetails',
        'terminal_features': 'ElavonFeatures',
        'fraud_detection': 'ElavonFraudDetection',
        'integration_settings': 'ElavonIntegrationSettings',
