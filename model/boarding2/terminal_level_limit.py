...
class TerminalLevelLimit(SwaggerSerializable):
    swagger_types = {
        'limit_threshold': 'int',
        'limit_scope': 'str',
        'current_value': 'float',
    ...
    def __init__(self, limit_threshold=None, limit_scope=None, current_value=None, without_cvv_only=None, without_avs_only=None):  # noqa: E501
