...
class TerminalLevelLimit(object):
    ...
    def __init__(self, limit_scope=None, limit_threshold=None, without_cvv_only=None, without_avs_only=None, current_value=None):  # noqa: E501
        """TerminalLevelLimit - a model defined in Swagger"""  # noqa: E501
    ...
    def limit_scope(self):
        """Gets the limit_scope of this TerminalLevelLimit.  # noqa: E501


        :return: The limit_scope of this TerminalLevelLimit.  # noqa: E501
        :rtype: str
        """
    ...
    def limit_scope(self, limit_scope):
        """Sets the limit_scope of this TerminalLevelLimit.


        :param limit_scope: The limit_scope of this TerminalLevelLimit.  # noqa: E501
        :type: str
        """
    ...
    def limit_threshold(self):
        """Gets the limit_threshold of this TerminalLevelLimit.  # noqa: E501

        The maximum amount allowed within the period described in the `limitScope` attribute.  # noqa: E501

        :return: The limit_threshold of this TerminalLevelLimit.  # noqa: E501
        :rtype: int
        """
    ...
    def limit_threshold(self, limit_threshold):
        """Sets the limit_threshold of this TerminalLevelLimit.

        The maximum amount allowed within the period described in the `limitScope` attribute.  # noqa: E501

        :param limit_threshold: The limit_threshold of this TerminalLevelLimit.  # noqa: E501
        :type: int
        """
    ...
    def without_cvv_only(self):
        """Gets the without_cvv_only of this TerminalLevelLimit.  # noqa: E501
        ...
        :return: The without_cvv_only of this TerminalLevelLimit.  # noqa: E501
        :rtype: bool
        """
    ...
    def without_cvv_only(self, without_cvv_only):
        """Sets the without_cvv_only of this TerminalLevelLimit.

        If enabled, the limit will only take transactions without CVV into account. This is specially useful for merchants who are looking for a way to add thresholds for transactions that may lead to chargebacks.<br />This filter only applies to limits within `SINGLE_TRANSACTION` scope.  # noqa: E501

        :param without_cvv_only: The without_cvv_only of this TerminalLevelLimit.  # noqa: E501
        :type: bool
        """
    ...
    def without_avs_only(self):
        """Gets the without_avs_only of this TerminalLevelLimit.  # noqa: E501
        ...
        :return: The without_avs_only of this TerminalLevelLimit.  # noqa: E501
        :rtype: bool
        """
    ...
    def without_avs_only(self, without_avs_only):
        """Sets the without_avs_only of this TerminalLevelLimit.

        If enabled, the limit will only take transactions without AVS into account. This is specially useful for merchants who are looking for a way to add thresholds for transactions that may lead to chargebacks.<br />This filter only applies to limits within `SINGLE_TRANSACTION` scope.  # noqa: E501

        :param without_avs_only: The without_avs_only of this TerminalLevelLimit.  # noqa: E501
        :type: bool
        """
    ...
    def current_value(self):
        """Gets the current_value of this TerminalLevelLimit.  # noqa: E501

        The sum of all transactions performed by the terminal within the period described in the `limitScope` attribute.<br />At the end of each period, this value is reset.  # noqa: E501

        :return: The current_value of this TerminalLevelLimit.  # noqa: E501
        :rtype: float
        """
    ...
    def current_value(self, current_value):
        """Sets the current_value of this TerminalLevelLimit.

        The sum of all transactions performed by the terminal within the period described in the `limitScope` attribute.<br />At the end of each period, this value is reset.  # noqa: E501

        :param current_value: The current_value of this TerminalLevelLimit.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TerminalLevelLimit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TerminalLevelLimit):
            return False
