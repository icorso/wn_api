...
class ProcessingRuleInstruction(object):
    ...
    def __init__(self, action=None, terminal=None):  # noqa: E501
    ...
    @property
    def terminal(self):
        """Gets the terminal of this ProcessingRuleInstruction.  # noqa: E501

        The number of the terminal which is the target of the action.  # noqa: E501

        :return: The terminal of this ProcessingRuleInstruction.  # noqa: E501
        :rtype: str
        """
    ...
    def terminal(self, terminal):
        """Sets the terminal of this ProcessingRuleInstruction.

        The number of the terminal which is the target of the action.  # noqa: E501

        :param terminal: The terminal of this ProcessingRuleInstruction.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProcessingRuleInstruction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProcessingRuleInstruction):
            return False
