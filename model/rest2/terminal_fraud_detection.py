...
class TerminalFraudDetection(object):
    ...
    def __init__(self, allow_cardholder_signature_bypass=None, allow_unreferenced_refunds=None, unreferenced_refund_amount_limit=None, refund_percentage_limit=None, address_verification=None, cvv_verification=None, three_d_secure=None):  # noqa: E501
        """TerminalFraudDetection - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_cardholder_signature_bypass(self):
        """Gets the allow_cardholder_signature_bypass of this TerminalFraudDetection.  # noqa: E501

        Indicates whether cardholder signature requirement should be relaxed.  # noqa: E501

        :return: The allow_cardholder_signature_bypass of this TerminalFraudDetection.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_cardholder_signature_bypass(self, allow_cardholder_signature_bypass):
        """Sets the allow_cardholder_signature_bypass of this TerminalFraudDetection.

        Indicates whether cardholder signature requirement should be relaxed.  # noqa: E501

        :param allow_cardholder_signature_bypass: The allow_cardholder_signature_bypass of this TerminalFraudDetection.  # noqa: E501
        :type: bool
        """
        if allow_cardholder_signature_bypass is None:
            raise ValueError("Invalid value for `allow_cardholder_signature_bypass`, must not be `None`")  # noqa: E501

        self._allow_cardholder_signature_bypass = allow_cardholder_signature_bypass

    @property
    def allow_unreferenced_refunds(self):
        """Gets the allow_unreferenced_refunds of this TerminalFraudDetection.  # noqa: E501

        Indicates whether the terminal allows unreferenced refunds.<br />This type of refunds do not require a prior payment transaction to be referenced.  # noqa: E501

        :return: The allow_unreferenced_refunds of this TerminalFraudDetection.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_unreferenced_refunds(self, allow_unreferenced_refunds):
        """Sets the allow_unreferenced_refunds of this TerminalFraudDetection.

        Indicates whether the terminal allows unreferenced refunds.<br />This type of refunds do not require a prior payment transaction to be referenced.  # noqa: E501

        :param allow_unreferenced_refunds: The allow_unreferenced_refunds of this TerminalFraudDetection.  # noqa: E501
        :type: bool
        """
        if allow_unreferenced_refunds is None:
            raise ValueError("Invalid value for `allow_unreferenced_refunds`, must not be `None`")  # noqa: E501

        self._allow_unreferenced_refunds = allow_unreferenced_refunds

    @property
    def unreferenced_refund_amount_limit(self):
        """Gets the unreferenced_refund_amount_limit of this TerminalFraudDetection.  # noqa: E501

        Amount threshold for unreferenced refunds.  # noqa: E501

        :return: The unreferenced_refund_amount_limit of this TerminalFraudDetection.  # noqa: E501
        :rtype: int
        """
    ...
    def unreferenced_refund_amount_limit(self, unreferenced_refund_amount_limit):
        """Sets the unreferenced_refund_amount_limit of this TerminalFraudDetection.

        Amount threshold for unreferenced refunds.  # noqa: E501

        :param unreferenced_refund_amount_limit: The unreferenced_refund_amount_limit of this TerminalFraudDetection.  # noqa: E501
        :type: int
        """
        if unreferenced_refund_amount_limit is None:
            raise ValueError("Invalid value for `unreferenced_refund_amount_limit`, must not be `None`")  # noqa: E501

        self._unreferenced_refund_amount_limit = unreferenced_refund_amount_limit

    @property
    def refund_percentage_limit(self):
        """Gets the refund_percentage_limit of this TerminalFraudDetection.  # noqa: E501

        The percentage limit for referenced refunds. This is usually configured at 100% of the original transaction's amount.  # noqa: E501

        :return: The refund_percentage_limit of this TerminalFraudDetection.  # noqa: E501
        :rtype: float
        """
    ...
    def refund_percentage_limit(self, refund_percentage_limit):
        """Sets the refund_percentage_limit of this TerminalFraudDetection.

        The percentage limit for referenced refunds. This is usually configured at 100% of the original transaction's amount.  # noqa: E501

        :param refund_percentage_limit: The refund_percentage_limit of this TerminalFraudDetection.  # noqa: E501
        :type: float
        """
        if refund_percentage_limit is None:
            raise ValueError("Invalid value for `refund_percentage_limit`, must not be `None`")  # noqa: E501

        self._refund_percentage_limit = refund_percentage_limit

    @property
    def address_verification(self):
        """Gets the address_verification of this TerminalFraudDetection.  # noqa: E501


        :return: The address_verification of this TerminalFraudDetection.  # noqa: E501
    ...
    def address_verification(self, address_verification):
        """Sets the address_verification of this TerminalFraudDetection.


        :param address_verification: The address_verification of this TerminalFraudDetection.  # noqa: E501
    ...
    def cvv_verification(self):
        """Gets the cvv_verification of this TerminalFraudDetection.  # noqa: E501


        :return: The cvv_verification of this TerminalFraudDetection.  # noqa: E501
    ...
    def cvv_verification(self, cvv_verification):
        """Sets the cvv_verification of this TerminalFraudDetection.


        :param cvv_verification: The cvv_verification of this TerminalFraudDetection.  # noqa: E501
    ...
    def three_d_secure(self):
        """Gets the three_d_secure of this TerminalFraudDetection.  # noqa: E501


        :return: The three_d_secure of this TerminalFraudDetection.  # noqa: E501
        :rtype: ThreeDSecure
        """
    ...
    def three_d_secure(self, three_d_secure):
        """Sets the three_d_secure of this TerminalFraudDetection.


        :param three_d_secure: The three_d_secure of this TerminalFraudDetection.  # noqa: E501
        :type: ThreeDSecure
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TerminalFraudDetection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TerminalFraudDetection):
            return False
