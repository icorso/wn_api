...
class PosRefundRequest(SwaggerSerializable):
    swagger_types = {
        'channel': 'str',
        'terminal': 'str',
        'operator': 'str',
    ...
    def __init__(self, channel=None, terminal=None, operator=None, order_id=None, currency=None, refund_amount=None, refund_reason=None, customer=None, customer_account=None, ip_address=None, additional_data_fields=None, *args, **kwargs):  # noqa: E501
        """PosRefundRequest - a model defined in Swagger"""  # noqa: E501
        self._channel = None
        self._terminal = None
        self._operator = None
        self._order_id = None
    ...
    @property
    def channel(self):
        """Gets the channel of this PosRefundRequest.  # noqa: E501


        :return: The channel of this PosRefundRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this PosRefundRequest.


        :param channel: The channel of this PosRefundRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def terminal(self):
        """Gets the terminal of this PosRefundRequest.  # noqa: E501

        The terminal number assigned by the gateway.  # noqa: E501

        :return: The terminal of this PosRefundRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def terminal(self, terminal):
        """Sets the terminal of this PosRefundRequest.

        The terminal number assigned by the gateway.  # noqa: E501

        :param terminal: The terminal of this PosRefundRequest.  # noqa: E501
        :type: str
        """
        if terminal is None:
    ...
    @property
    def operator(self):
        """Gets the operator of this PosRefundRequest.  # noqa: E501
        ...
        :return: The operator of this PosRefundRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def operator(self, operator):
        """Sets the operator of this PosRefundRequest.

        The operator who initiated the transaction. If not sent in the request, this field will be automatically populated with the API Key alias.  # noqa: E501

        :param operator: The operator of this PosRefundRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def order_id(self):
        """Gets the order_id of this PosRefundRequest.  # noqa: E501

        A unique identifier for the order assigned by the merchant.  # noqa: E501

        :return: The order_id of this PosRefundRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        """Sets the order_id of this PosRefundRequest.

        A unique identifier for the order assigned by the merchant.  # noqa: E501

        :param order_id: The order_id of this PosRefundRequest.  # noqa: E501
        :type: str
        """
        if order_id is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this PosRefundRequest.  # noqa: E501
        ...
        :return: The currency of this PosRefundRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this PosRefundRequest.

        The currency of the transaction. A 3-letter code as per the [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217#Active_codes) standard.  # noqa: E501

        :param currency: The currency of this PosRefundRequest.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    def refund_amount(self):
        """Gets the refund_amount of this PosRefundRequest.  # noqa: E501

        The total amount to be refunded.  # noqa: E501

        :return: The refund_amount of this PosRefundRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def refund_amount(self, refund_amount):
        """Sets the refund_amount of this PosRefundRequest.

        The total amount to be refunded.  # noqa: E501

        :param refund_amount: The refund_amount of this PosRefundRequest.  # noqa: E501
        :type: float
        """
    ...
    def refund_reason(self):
        """Gets the refund_reason of this PosRefundRequest.  # noqa: E501

        The reason why the refund is being performed.  # noqa: E501

        :return: The refund_reason of this PosRefundRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def refund_reason(self, refund_reason):
        """Sets the refund_reason of this PosRefundRequest.

        The reason why the refund is being performed.  # noqa: E501

        :param refund_reason: The refund_reason of this PosRefundRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def customer(self):
        """Gets the customer of this PosRefundRequest.  # noqa: E501


        :return: The customer of this PosRefundRequest.  # noqa: E501
        :rtype: Customer
        """
    ...
    def customer(self, customer):
        """Sets the customer of this PosRefundRequest.


        :param customer: The customer of this PosRefundRequest.  # noqa: E501
        :type: Customer
        """
    ...
    def customer_account(self):
        """Gets the customer_account of this PosRefundRequest.  # noqa: E501


        :return: The customer_account of this PosRefundRequest.  # noqa: E501
        :rtype: Payload
        """
    ...
    def customer_account(self, customer_account):
        """Sets the customer_account of this PosRefundRequest.


        :param customer_account: The customer_account of this PosRefundRequest.  # noqa: E501
        :type: Payload
        """
    ...
    @property
    def ip_address(self):
        """Gets the ip_address of this PosRefundRequest.  # noqa: E501


        :return: The ip_address of this PosRefundRequest.  # noqa: E501
        :rtype: IpAddress
        """
    ...
    def ip_address(self, ip_address):
        """Sets the ip_address of this PosRefundRequest.


        :param ip_address: The ip_address of this PosRefundRequest.  # noqa: E501
        :type: IpAddress
        """
    ...
    def additional_data_fields(self):
        """Gets the additional_data_fields of this PosRefundRequest.  # noqa: E501
        ...
        :return: The additional_data_fields of this PosRefundRequest.  # noqa: E501
    ...
    def additional_data_fields(self, additional_data_fields):
        """Sets the additional_data_fields of this PosRefundRequest.

        List of custom fields which are used to add extra information to transactions. Their values are going to be stored and used for the requests sent to the terminal's receipt and validation webhooks.<br />To understand more visit the section regarding [Special Fields and Parameters](https://docs.worldnettps.com/doku.php?id=developer:api_specification:special_fields_and_parameters).  # noqa: E501

        :param additional_data_fields: The additional_data_fields of this PosRefundRequest.  # noqa: E501
