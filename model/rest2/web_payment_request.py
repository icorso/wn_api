...
class WebPaymentRequest(SwaggerSerializable):
    swagger_types = {
        'channel': 'str',
        'terminal': 'str',
        'operator': 'str',
    ...
    def __init__(self, channel=None, terminal=None, operator=None, order=None, customer=None, customer_account=None, ip_address=None, auto_capture=True, process_as_sale=False, offline_processing=None, additional_data_fields=None, *args, **kwargs):  # noqa: E501
        """WebPaymentRequest - a model defined in Swagger"""  # noqa: E501
        self._channel = None
        self._terminal = None
        self._operator = None
        self._order = None
        ...
        PaymentRequest.__init__(self, *args, **kwargs)

    @property
    def channel(self):
        """Gets the channel of this WebPaymentRequest.  # noqa: E501


        :return: The channel of this WebPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this WebPaymentRequest.


        :param channel: The channel of this WebPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def terminal(self):
        """Gets the terminal of this WebPaymentRequest.  # noqa: E501

        The terminal number assigned by the gateway.  # noqa: E501

        :return: The terminal of this WebPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def terminal(self, terminal):
        """Sets the terminal of this WebPaymentRequest.

        The terminal number assigned by the gateway.  # noqa: E501

        :param terminal: The terminal of this WebPaymentRequest.  # noqa: E501
        :type: str
        """
        if terminal is None:
    ...
    @property
    def operator(self):
        """Gets the operator of this WebPaymentRequest.  # noqa: E501
        ...
        :return: The operator of this WebPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def operator(self, operator):
        """Sets the operator of this WebPaymentRequest.

        The operator who initiated the transaction. If not sent in the request, this field will be automatically populated with the API Key alias.  # noqa: E501

        :param operator: The operator of this WebPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def order(self):
        """Gets the order of this WebPaymentRequest.  # noqa: E501


        :return: The order of this WebPaymentRequest.  # noqa: E501
        :rtype: Order
        """
        return self._order
    ...
    def order(self, order):
        """Sets the order of this WebPaymentRequest.


        :param order: The order of this WebPaymentRequest.  # noqa: E501
        :type: Order
        """
        if order is None:
    ...
    @property
    def customer(self):
        """Gets the customer of this WebPaymentRequest.  # noqa: E501


        :return: The customer of this WebPaymentRequest.  # noqa: E501
        :rtype: Customer
        """
    ...
    def customer(self, customer):
        """Sets the customer of this WebPaymentRequest.


        :param customer: The customer of this WebPaymentRequest.  # noqa: E501
        :type: Customer
        """
    ...
    def customer_account(self):
        """Gets the customer_account of this WebPaymentRequest.  # noqa: E501


        :return: The customer_account of this WebPaymentRequest.  # noqa: E501
        :rtype: Payload
        """
    ...
    def customer_account(self, customer_account):
        """Sets the customer_account of this WebPaymentRequest.


        :param customer_account: The customer_account of this WebPaymentRequest.  # noqa: E501
        :type: Payload
        """
    ...
    @property
    def ip_address(self):
        """Gets the ip_address of this WebPaymentRequest.  # noqa: E501


        :return: The ip_address of this WebPaymentRequest.  # noqa: E501
        :rtype: IpAddress
        """
    ...
    def ip_address(self, ip_address):
        """Sets the ip_address of this WebPaymentRequest.


        :param ip_address: The ip_address of this WebPaymentRequest.  # noqa: E501
        :type: IpAddress
        """
    ...
    def auto_capture(self):
        """Gets the auto_capture of this WebPaymentRequest.  # noqa: E501
        ...
        :return: The auto_capture of this WebPaymentRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_capture(self, auto_capture):
        """Sets the auto_capture of this WebPaymentRequest.

        It indicates whether the amount of the transaction should be automatically and fully captured.  - `true` : the gateway will automatically set the transaction to `READY` making it eligible for the next settlement run. - `false`: a pre-authorization will be performed if your account has the \"Allow Pre-Auth\" feature enabled. Otherwise, a regular transaction will be created with `PENDING` status. Either way, an additional call to the [Capture a Payment](#operation/capturePayment) operation is required to capture the final amount and flag the transaction as ready for the next settlement run.  # noqa: E501

        :param auto_capture: The auto_capture of this WebPaymentRequest.  # noqa: E501
        :type: bool
        """
    ...
    def process_as_sale(self):
        """Gets the process_as_sale of this WebPaymentRequest.  # noqa: E501
        ...
        :return: The process_as_sale of this WebPaymentRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def process_as_sale(self, process_as_sale):
        """Sets the process_as_sale of this WebPaymentRequest.

        Indicates whether the transaction should be processed as a Sale. A Sale transaction is characterized by its `COMPLETE` status due to the fact that authorization and settlement operations are performed at the same time. This means that this kind of transaction is not subject to changes or late adjustments even while sitting in the open batch.  **Note:** The `autoCapture` indicator must be set to TRUE to process a Sale.  # noqa: E501

        :param process_as_sale: The process_as_sale of this WebPaymentRequest.  # noqa: E501
        :type: bool
        """
    ...
    def offline_processing(self):
        """Gets the offline_processing of this WebPaymentRequest.  # noqa: E501


        :return: The offline_processing of this WebPaymentRequest.  # noqa: E501
    ...
    def offline_processing(self, offline_processing):
        """Sets the offline_processing of this WebPaymentRequest.


        :param offline_processing: The offline_processing of this WebPaymentRequest.  # noqa: E501
    ...
    def additional_data_fields(self):
        """Gets the additional_data_fields of this WebPaymentRequest.  # noqa: E501
        ...
        :return: The additional_data_fields of this WebPaymentRequest.  # noqa: E501
    ...
    def additional_data_fields(self, additional_data_fields):
        """Sets the additional_data_fields of this WebPaymentRequest.

        List of custom fields which are used to add extra information to transactions. Their values are going to be stored and used for the requests sent to the terminal's receipt and validation webhooks.<br />For more information, visit the section [Special Fields and Parameters](https://docs.worldnettps.com/doku.php?id=developer:api_specification:special_fields_and_parameters) of our knowledge base.  # noqa: E501

        :param additional_data_fields: The additional_data_fields of this WebPaymentRequest.  # noqa: E501
