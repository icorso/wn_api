...
class TerminalCompact(object):
    ...
    def __init__(self, payment_processor=None, terminal_number=None, display_name=None, base_currency=None, time_zone=None, links=None):  # noqa: E501
        """TerminalCompact - a model defined in Swagger"""  # noqa: E501
    ...
    def payment_processor(self):
        """Gets the payment_processor of this TerminalCompact.  # noqa: E501

        The financial entity that will process and authorize the operations performed by the terminal.  # noqa: E501

        :return: The payment_processor of this TerminalCompact.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_processor(self, payment_processor):
        """Sets the payment_processor of this TerminalCompact.

        The financial entity that will process and authorize the operations performed by the terminal.  # noqa: E501

        :param payment_processor: The payment_processor of this TerminalCompact.  # noqa: E501
        :type: str
        """
    ...
    def terminal_number(self):
        """Gets the terminal_number of this TerminalCompact.  # noqa: E501

        Unique number assigned by the gateway.  # noqa: E501

        :return: The terminal_number of this TerminalCompact.  # noqa: E501
        :rtype: str
        """
    ...
    def terminal_number(self, terminal_number):
        """Sets the terminal_number of this TerminalCompact.

        Unique number assigned by the gateway.  # noqa: E501

        :param terminal_number: The terminal_number of this TerminalCompact.  # noqa: E501
        :type: str
        """
    ...
    def display_name(self):
        """Gets the display_name of this TerminalCompact.  # noqa: E501

        Friendly name assigned by the merchant.  # noqa: E501

        :return: The display_name of this TerminalCompact.  # noqa: E501
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this TerminalCompact.

        Friendly name assigned by the merchant.  # noqa: E501

        :param display_name: The display_name of this TerminalCompact.  # noqa: E501
        :type: str
        """
    ...
    def base_currency(self):
        """Gets the base_currency of this TerminalCompact.  # noqa: E501
        ...
        :return: The base_currency of this TerminalCompact.  # noqa: E501
        :rtype: str
        """
    ...
    def base_currency(self, base_currency):
        """Sets the base_currency of this TerminalCompact.

        The terminal's base currency used for single currency transactions as well as MCP and DCC processing.  **Note:** Terminals where `allowMulticurrency` is enabled will not have a base currency.  # noqa: E501

        :param base_currency: The base_currency of this TerminalCompact.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this TerminalCompact.  # noqa: E501

        Terminal's preferred time-zone.  # noqa: E501

        :return: The time_zone of this TerminalCompact.  # noqa: E501
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this TerminalCompact.

        Terminal's preferred time-zone.  # noqa: E501

        :param time_zone: The time_zone of this TerminalCompact.  # noqa: E501
        :type: str
        """
    ...
    @property
    def links(self):
        """Gets the links of this TerminalCompact.  # noqa: E501

        List of hypermedia links containing the operations available for the resource.  # noqa: E501

        :return: The links of this TerminalCompact.  # noqa: E501
    ...
    def links(self, links):
        """Sets the links of this TerminalCompact.

        List of hypermedia links containing the operations available for the resource.  # noqa: E501

        :param links: The links of this TerminalCompact.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TerminalCompact, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TerminalCompact):
            return False
