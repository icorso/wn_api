...
class MerchantDetails(object):
    ...
    swagger_types = {
        ...
        'website': 'str',
        'address': 'Address',
        'merchant_volume_limits': 'list[MerchantLevelLimit]'
    }
    ...
    def __init__(self, name=None, mcc=None, phone=None, email=None, website=None, address=None, merchant_volume_limits=None):  # noqa: E501
        """MerchantDetails - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._mcc = None
        self._phone = None
        self._email = None
        self._website = None
        self._address = None
        self._merchant_volume_limits = None
        ...
        if merchant_volume_limits is not None:
            self.merchant_volume_limits = merchant_volume_limits

    @property
    def name(self):
        """Gets the name of this MerchantDetails.  # noqa: E501

        Merchant's DBA (Doing Business As). This information will appear on transaction receipts.  # noqa: E501

        :return: The name of this MerchantDetails.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MerchantDetails.

        Merchant's DBA (Doing Business As). This information will appear on transaction receipts.  # noqa: E501

        :param name: The name of this MerchantDetails.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def mcc(self):
        """Gets the mcc of this MerchantDetails.  # noqa: E501

        Merchant Category Code. It is a four-digit number listed in ISO 18245 for retail financial services. An MCC is used to classify a business by the types of goods or services it provides.  # noqa: E501

        :return: The mcc of this MerchantDetails.  # noqa: E501
        :rtype: str
        """
        return self._mcc
    ...
    def mcc(self, mcc):
        ...
        :param mcc: The mcc of this MerchantDetails.  # noqa: E501
        :type: str
        """
        if mcc is None:
    ...
    @property
    def phone(self):
        """Gets the phone of this MerchantDetails.  # noqa: E501

        Merchant's phone number. This information will appear on transaction receipts.  # noqa: E501

        :return: The phone of this MerchantDetails.  # noqa: E501
        :rtype: str
        """
        return self._phone
    ...
    def phone(self, phone):
        """Sets the phone of this MerchantDetails.

        Merchant's phone number. This information will appear on transaction receipts.  # noqa: E501

        :param phone: The phone of this MerchantDetails.  # noqa: E501
        :type: str
        """
        if phone is None:
    ...
    @property
    def email(self):
        """Gets the email of this MerchantDetails.  # noqa: E501

        Merchant's email address. This information will appear on transaction receipts.  # noqa: E501

        :return: The email of this MerchantDetails.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this MerchantDetails.

        Merchant's email address. This information will appear on transaction receipts.  # noqa: E501

        :param email: The email of this MerchantDetails.  # noqa: E501
        :type: str
        """
        if email is None:
    ...
    @property
    def website(self):
        """Gets the website of this MerchantDetails.  # noqa: E501

        Merchant's web page. This information will appear on transaction receipts.  # noqa: E501

        :return: The website of this MerchantDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def website(self, website):
        """Sets the website of this MerchantDetails.

        Merchant's web page. This information will appear on transaction receipts.  # noqa: E501

        :param website: The website of this MerchantDetails.  # noqa: E501
        :type: str
        """
    ...
    @property
    def address(self):
        """Gets the address of this MerchantDetails.  # noqa: E501


        :return: The address of this MerchantDetails.  # noqa: E501
        :rtype: Address
        """
    ...
    def address(self, address):
        """Sets the address of this MerchantDetails.


        :param address: The address of this MerchantDetails.  # noqa: E501
        :type: Address
        """
    ...
    @property
    def merchant_volume_limits(self):
        """Gets the merchant_volume_limits of this MerchantDetails.  # noqa: E501

        List of merchant-level volume limits.  # noqa: E501

        :return: The merchant_volume_limits of this MerchantDetails.  # noqa: E501
        :rtype: list[MerchantLevelLimit]
        """
        return self._merchant_volume_limits

    @merchant_volume_limits.setter
    def merchant_volume_limits(self, merchant_volume_limits):
        """Sets the merchant_volume_limits of this MerchantDetails.

        List of merchant-level volume limits.  # noqa: E501

        :param merchant_volume_limits: The merchant_volume_limits of this MerchantDetails.  # noqa: E501
        :type: list[MerchantLevelLimit]
        """

        self._merchant_volume_limits = merchant_volume_limits
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MerchantDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MerchantDetails):
            return False
