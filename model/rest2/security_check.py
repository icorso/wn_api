...
class SecurityCheck(object):
    ...
    def __init__(self, cvv_result=None, avs_result=None):  # noqa: E501
        """SecurityCheck - a model defined in Swagger"""  # noqa: E501
        self._cvv_result = None
    ...
    @property
    def cvv_result(self):
        """Gets the cvv_result of this SecurityCheck.  # noqa: E501


        :return: The cvv_result of this SecurityCheck.  # noqa: E501
        :rtype: str
        """
        return self._cvv_result

    @cvv_result.setter
    def cvv_result(self, cvv_result):
        """Sets the cvv_result of this SecurityCheck.


        :param cvv_result: The cvv_result of this SecurityCheck.  # noqa: E501
        :type: str
        """
        allowed_values = ["M", "N", "P", "U"]  # noqa: E501
        if cvv_result not in allowed_values:
            raise ValueError(
                "Invalid value for `cvv_result` ({0}), must be one of {1}"  # noqa: E501
                .format(cvv_result, allowed_values)
            )

        self._cvv_result = cvv_result

    @property
    def avs_result(self):
        """Gets the avs_result of this SecurityCheck.  # noqa: E501


        :return: The avs_result of this SecurityCheck.  # noqa: E501
        :rtype: str
        """
    ...
    def avs_result(self, avs_result):
        """Sets the avs_result of this SecurityCheck.


        :param avs_result: The avs_result of this SecurityCheck.  # noqa: E501
        :type: str
        """
        allowed_values = ["Y", "A", "Z", "N", "U", "R", "G", "S", "F", "W", "X"]  # noqa: E501
        if avs_result not in allowed_values:
            raise ValueError(
                "Invalid value for `avs_result` ({0}), must be one of {1}"  # noqa: E501
                .format(avs_result, allowed_values)
            )
