...
class TerminalTax(object):
    ...
    def __init__(self, unique_reference=None, name=None, rate=None):  # noqa: E501
        """TerminalTax - a model defined in Swagger"""  # noqa: E501
    ...
    def unique_reference(self):
        """Gets the unique_reference of this TerminalTax.  # noqa: E501

        Unique reference number assigned by the gateway. This field must be used when trying to update an existing terminal's tax.  # noqa: E501

        :return: The unique_reference of this TerminalTax.  # noqa: E501
        :rtype: str
        """
    ...
    def unique_reference(self, unique_reference):
        """Sets the unique_reference of this TerminalTax.

        Unique reference number assigned by the gateway. This field must be used when trying to update an existing terminal's tax.  # noqa: E501

        :param unique_reference: The unique_reference of this TerminalTax.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this TerminalTax.  # noqa: E501

        Tax Name.  # noqa: E501

        :return: The name of this TerminalTax.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TerminalTax.

        Tax Name.  # noqa: E501

        :param name: The name of this TerminalTax.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def rate(self):
        """Gets the rate of this TerminalTax.  # noqa: E501

        The ratio expressed as a percentage at which a transaction is taxed.  # noqa: E501

        :return: The rate of this TerminalTax.  # noqa: E501
        :rtype: float
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this TerminalTax.

        The ratio expressed as a percentage at which a transaction is taxed.  # noqa: E501

        :param rate: The rate of this TerminalTax.  # noqa: E501
        :type: float
        """
        if rate is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TerminalTax, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TerminalTax):
            return False
