...
class DigitalWalletPayload(object):
    ...
    def __init__(self, payload_type=None, account_type='CHECKING', service_provider=None, cardholder_name=None, encrypted_data=None, *args, **kwargs):  # noqa: E501
        """DigitalWalletPayload - a model defined in Swagger"""  # noqa: E501
    ...
    def payload_type(self):
        """Gets the payload_type of this DigitalWalletPayload.  # noqa: E501


        :return: The payload_type of this DigitalWalletPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def payload_type(self, payload_type):
        """Sets the payload_type of this DigitalWalletPayload.


        :param payload_type: The payload_type of this DigitalWalletPayload.  # noqa: E501
        :type: str
        """
    ...
    def account_type(self):
        """Gets the account_type of this DigitalWalletPayload.  # noqa: E501


        :return: The account_type of this DigitalWalletPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def account_type(self, account_type):
        """Sets the account_type of this DigitalWalletPayload.


        :param account_type: The account_type of this DigitalWalletPayload.  # noqa: E501
        :type: str
        """
    ...
    def service_provider(self):
        """Gets the service_provider of this DigitalWalletPayload.  # noqa: E501

        The wallet application provider.  # noqa: E501

        :return: The service_provider of this DigitalWalletPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def service_provider(self, service_provider):
        """Sets the service_provider of this DigitalWalletPayload.

        The wallet application provider.  # noqa: E501

        :param service_provider: The service_provider of this DigitalWalletPayload.  # noqa: E501
        :type: str
        """
        if service_provider is None:
            raise ValueError("Invalid value for `service_provider`, must not be `None`")  # noqa: E501
        allowed_values = ["GOOGLE", "APPLE"]  # noqa: E501
        if service_provider not in allowed_values:
            raise ValueError(
                "Invalid value for `service_provider` ({0}), must be one of {1}"  # noqa: E501
                .format(service_provider, allowed_values)
            )
    ...
    def cardholder_name(self):
        """Gets the cardholder_name of this DigitalWalletPayload.  # noqa: E501

        The cardholder's name as it appears on the card.  # noqa: E501

        :return: The cardholder_name of this DigitalWalletPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def cardholder_name(self, cardholder_name):
        """Sets the cardholder_name of this DigitalWalletPayload.

        The cardholder's name as it appears on the card.  # noqa: E501

        :param cardholder_name: The cardholder_name of this DigitalWalletPayload.  # noqa: E501
        :type: str
        """
    ...
    def encrypted_data(self):
        """Gets the encrypted_data of this DigitalWalletPayload.  # noqa: E501

        The encrypted data generated by the digital wallet application.  # noqa: E501

        :return: The encrypted_data of this DigitalWalletPayload.  # noqa: E501
        :rtype: str
        """
    ...
    def encrypted_data(self, encrypted_data):
        """Sets the encrypted_data of this DigitalWalletPayload.

        The encrypted data generated by the digital wallet application.  # noqa: E501

        :param encrypted_data: The encrypted_data of this DigitalWalletPayload.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DigitalWalletPayload, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DigitalWalletPayload):
            return False
