...
class MerchantLevelLimit(object):
    ...
    def __init__(self, limit_scope=None, limit_threshold=None, without_cvv_only=None, without_avs_only=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MerchantLevelLimit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MerchantLevelLimit):
            return False
