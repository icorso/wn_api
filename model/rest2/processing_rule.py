...
class ProcessingRule(object):
    ...
    def __init__(self, enable=None, conditions=None, then=None):  # noqa: E501
        """ProcessingRule - a model defined in Swagger"""  # noqa: E501
        self._enable = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProcessingRule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProcessingRule):
            return False
